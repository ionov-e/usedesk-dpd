...
4. Перейти к следующему разделу - [создание файла **.env**](#usedesk_url)
5. При желании можно сделать копию файла `index.php.example` в папке **public** и переименовать копию
   ...
   в [URL при настройках блока Usedesk](#Создание-редактирование-файла-окружения-.env) достаточно будет ввести
